...
![20260201_210146](https://github.com/user-attachments/assets/ed8db861-19fc-49b7-967f-91d3ab9c8220)
...
* 5.本体への取り付け
  ...
  * 5.1 中央上部と中央下部取り付け  
  * 画像赤枠の部分が  
  　・ロータリーエンコーダ拡張基盤上部用スペーサー  
  　・Reex本体基盤  
  　・上：ロータリーエンコーダ拡張中央上部/下部用スペーサー  
　　下：ロータリーエンコーダ拡張中央上部/下部用スペーサー  
  　・ロータリーエンコーダ拡張基盤  
  　・3.5mmmmスペーサー  
