...
QMKにReex56のコードはまだマージされていませんのでこの[ブランチ](https://github.com/kushima8/qmk_firmware/tree/reex)を使用してください。  
...
[プレートデータ](https://github.com/kushima8/Reex/tree/main/Reex56/Plate)データを公開しています。  
